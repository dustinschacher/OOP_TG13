...
class Lol3 {
    public static void main(String[] args) {
        ...
        //Parkplatz der Schueler bestimmen
        System.out.println("\n----- Parkplatz der Schueler ---------");
        Parkplatz p = map.get(s1);
        Parkplatz pa = map.get(s2);
        Parkplatz par = map.get(s3);
        System.out.println("Der Schüler "+s1.getName()+" hat den Parkplatz "+p.getParkplatzNr());
        System.out.println("Der Schüler "+s2.getName()+" hat den Parkplatz "+pa.getParkplatzNr());
        System.out.println("Der Schüler "+s3.getName()+" hat den Parkplatz "+par.getParkplatzNr());
